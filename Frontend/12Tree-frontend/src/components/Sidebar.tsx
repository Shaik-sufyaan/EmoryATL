...
export default function Sidebar() {
  return (
    <aside className="hidden md:flex w-64 shrink-0 flex-col gap-4 p-6 bg-gradient-to-b from-white to-gray-50 border-r border-gray-100 relative z-20">
      {/* App Logo/Branding */}
      ...
      {/* Main navigation with stretched white background */}
      <div className="flex-1 flex flex-col gap-4 bg-white rounded-3xl p-4 shadow-soft">
        ...
        {/* User profile at bottom of white section */}
